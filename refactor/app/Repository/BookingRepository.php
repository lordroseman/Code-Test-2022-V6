...
use App\Services\Job\CreateJob;
use App\Services\Job\UpdateJob;
...
//            $jobs['total'] = $totaljobs;
    ...
    public function store($user, $data)
    {
       ...
       $createJobService = new CreateJob($user, $data);
       $result = $createJobService->save();
...
//        $jobs = TeHelper::convertJobIdsInObjs($job_ids);
    ...
    public function updateJob($id, $data, $cuser)
    {
        ...
        $updateJobService = new UpdateJob($id, $data, $cuser);
        $result = $updateJobService->save();
